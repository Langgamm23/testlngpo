...
const SPACES = [
  ...
  { id: 7, name: 'Gaming', color: '#f472b6', members: 62100, description: 'Game discussions, trailers, reviews, esports, and setup showcases.' }
];
...
const SAMPLE_POSTS = [
  ...
  },
  {
    ...
    body: 'Tested under full synthetic loads and gaming workloads at 4K max settings. Thermal dissipation is remarkably stable with the new vapor chamber design.',
    author: 'Zach Reyes',
    handle: '@Zch.reyes',
    space: 'Hardware',
    flair: 'Review',
  ...
  {
    id: 7,
    title: 'What single-player game completely changed your perspective on gaming?',
    body: 'For me it was Outer Wilds and Red Dead Redemption 2. The sense of discovery and storytelling set a high bar. What is yours?',
    author: 'Pixel Explorer',
    handle: '@pixel_ex',
    space: 'Gaming',
    flair: 'Discussion',
    votes: 210,
...
const COMMUNITY_RULES = {
  ...
  'Gaming': [
    { num: 1, title: 'No Spoilers in Titles', desc: 'Use spoiler tags when discussing plot points or endgame content.' },
    { num: 2, title: 'No Console or Platform Wars', desc: 'Keep gaming discussions inclusive across PC, console, and mobile.' }
  ]
};
